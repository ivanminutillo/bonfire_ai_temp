...
```
cd extensions
git clone https://github.com/bonfire-networks/bonfire_ai.git {your-extension-name-here}
cd {your-extension-name-here} 
```
- Rename all the modules names to match your extension name:
    - Find & replace Bonfire.AI -> Bonfire.YourExtensionName 
    - Find & replace bonfire_ai -> bonfire_your_extension_name
- Rename the `bonfire_ai.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bonfire.AI.Web.Routes)` in your app's `Router` module
